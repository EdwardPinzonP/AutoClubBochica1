                                    ...
                                    @foreach($evidenciasAsignadas as $tarea)
                                        <div class="bg-white overflow-hidden shadow-md rounded-lg">
                                            ...
                                            <div class="bg-gray-100 px-4 py-4 sm:px-6">
                                                <a href="{{ route('descargarC2.adjunto', $tarea->Id_evidenciaR) }}" class="text-indigo-600 hover:text-indigo-900"><x-button class="ml-4">
                                                    {{ __('Descargar') }}
                                                </x-button></a>
                                            </div>
                                            <div class="bg-gray-100 px-4 py-4 sm:px-6">
                                                <a href="{{ route('calificaraprenc2', $tarea->Id_evidenciaR) }}" class="text-indigo-600 hover:text-indigo-900"><x-button class="ml-4">
                                                    {{ __('Calificar') }}
                                                </x-button></a>
                                            </div>
                                        </div>
