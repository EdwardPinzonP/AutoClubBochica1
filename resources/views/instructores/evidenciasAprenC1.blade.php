                                    ...
                                    @foreach($evidenciasAsignadas as $tarea)
                                        <div class="bg-white overflow-hidden shadow-md rounded-lg">
                                            ...
                                            <div class="bg-gray-100 px-4 py-4 sm:px-6">
                                                <a href="{{ route('descargarC1.adjunto', $tarea->Id_evidenciaR) }}" class="text-indigo-600 hover:text-indigo-900">Descargar</a>
                                            </div>
                                            <div class="bg-gray-100 px-4 py-4 sm:px-6">
                                                <a href="{{ route('calificaraprenc1', $tarea->Id_evidenciaR) }}" class="text-indigo-600 hover:text-indigo-900">Calificar</a>
                                            </div>
                                        </div>
                                    @endforeach
                                </div>
