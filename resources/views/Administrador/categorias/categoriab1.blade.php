                            ...
                            <table>
                                ...
                                @foreach($aprendices as $apren)
                                    <tr>
                                        ...
                                        <td><a href="{{ route('categoriaB1.destroy' , $apren->Id_aprendiz) }}" onclick="return confirm('Esta seguro de desvincular este usuario de la categoría B1?')"><button>Eliminar del curso</button></a></td>
                                    </tr>
                                @endforeach
                            </table>
                            ...
                            <table>
                                ...
                                @foreach($instructores as $profe)
                                    <tr>
                                        ...
                                        <td><a href="{{ route('categoriaB1.destroyIns' , $profe->Id_instructor) }}" onclick="return confirm('Esta seguro de desvincular este usuario de la categoría B1?')"><button>Eliminar del curso</button></a></td>
                                    </tr>
                                @endforeach
                            </table>
                        </div>
