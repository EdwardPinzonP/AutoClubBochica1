                            ...
                            <table>
                                ...
                                @foreach($aprendices as $apren)
                                    <tr>
                                        ...
                                        <td><a href="{{ route('categoriaA2.destroy' , $apren->Id_aprendiz) }}" onclick="return confirm('Esta seguro de desvincular este usuario de la categoría A2?')"><button>Eliminar del curso</button></a></td>
                                    </tr>
                                @endforeach
                            </table>
                            ...
                            <table>
                                ...
                                @foreach($instructores as $profe)
                                    <tr>
                                        ...
                                        <td><a href="{{ route('categoriaA2.destroyIns' , $profe->Id_instructor) }}" onclick="return confirm('Esta seguro de desvincular este usuario de la categoría A2?')"><button>Eliminar del curso</button></a></td>
                                    </tr>
                                @endforeach
                            </table>
                        </div>
